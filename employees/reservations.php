<?php
    ...
    $sql = "SELECT * FROM Reservations where Employees_empID = '$id'";
                ...
                <tbody>
                    ...
                    ?>
                                ...
                                <tr>
                                    ...
                                    <td><?php 
                                        $cusID = $row['Customers_cusID'];
                                        $sql2 = "SELECT * FROM customers WHERE cusID = '$cusID'";
                                        $result2 = $conn->query($sql2);
                                        $row2 = $result2->fetch_assoc();
                                        echo $cusID . " - " . $row2['cusName'];
                                    ?> </td>
                                    <td><?php echo $row2['cusPhone']; ?> </td>
                                    <td><?php echo $row2['cusEmail']; ?> </td>
